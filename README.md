...
![Dashboard](packages/node-red-contrib-flexradio/example/dashboard.png)
...
The [example](packages/node-red-contrib-flexradio/example) directory has the example flows shown below. You can install this flow in your Node Red instance, but you will have to change the radio address to make them work.
...
![Meters](packages/node-red-contrib-flexradio/example/meters.png)
